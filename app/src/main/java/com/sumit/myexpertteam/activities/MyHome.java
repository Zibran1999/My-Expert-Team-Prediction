...
public class MyHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void navigationDrawer() {
        ...
        navigationView.setNavigationItemSelectedListener(MyHome.this);
...
//            whatsApp(context, "com.whatsapp.w4b");
    ...
    public void inAppUpdate() {
        AppUpdateManager appUpdateManager = AppUpdateManagerFactory.create(MyHome.this);
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                // Request the update.
                try {
                    appUpdateManager.startUpdateFlowForResult(appUpdateInfo, AppUpdateType.IMMEDIATE, MyHome.this,
                            UPDATE_REQUEST_CODE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == UPDATE_REQUEST_CODE) {
            Toast.makeText(MyHome.this, "Downloading Started", Toast.LENGTH_SHORT).show();
